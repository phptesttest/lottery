...
<body id="app-layout" style='padding-top:70px;'>
    <nav class="navbar navbar-default navbar navbar-fixed-top" role="navigation">
        <div class="container-fluid">
            ...
            <a class="navbar-brand" onclick="{{ asset('/admin/index') }}" ><span class='glyphicon glyphicon-arrow-left'></span></a>
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
               ...
               <li class="dropdown">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">结算管理<span class="caret"></span></a>
                    <ul class="dropdown-menu" role="menu">
                        <li><a href="{{ asset('/admin/account')}}">结算处理</a></li>
                        <li><a href="{{ asset('/admin/withdraw')}}">结算处理记录</a></li>
                    </ul>
                </li>
                <li class="dropdown">
